...
/* Represents the euclidean rotation around each of the axes */
/* By convention, rotation about the axes should be performed in the order: x, y, z */
typedef Triple Rotation;
